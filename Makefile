# This Makefile is for the Mojolicious::Plugin::Mongodb extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Mojolicious/Plugin/Mongodb.pm]
#     AUTHOR => q[Ben van Staveren <madcat@cpan.org>]
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Mojolicious::Plugin::Mongodb]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], version=>q[0], MongoDB=>q[0], Mojolicious=>q[0] }
#     VERSION_FROM => q[lib/Mojolicious/Plugin/Mongodb.pm]
#     clean => { FILES=>q[Mojolicious-Plugin-Mongodb-*] }
...
MAKE = make
FULLEXT = Mojolicious/Plugin/Mongodb
BASEEXT = Mongodb
PARENT_NAME = Mojolicious::Plugin
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Mojolicious/Plugin/Mongodb.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Mojolicious/Plugin/Mongodb.pm
...
TO_INST_PM = lib/Mojolicious/Plugin/Mongodb.pm

PM_TO_BLIB = lib/Mojolicious/Plugin/Mongodb.pm \
...
manifypods : pure_all  \
	lib/Mojolicious/Plugin/Mongodb.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Mojolicious/Plugin/Mongodb.pm $(INST_MAN3DIR)/Mojolicious::Plugin::Mongodb.$(MAN3EXT) 
...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  *$(OBJ_EXT) pm_to_blib \
	  ...
	  $(BASEEXT).exp 
	- $(RM_RF) \
	  Mojolicious-Plugin-Mongodb-* blib 
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Mojolicious/Plugin/Mongodb.pm blib/lib/Mojolicious/Plugin/Mongodb.pm 
